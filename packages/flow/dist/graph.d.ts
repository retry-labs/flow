...
export function bezierFromPoints(pts: any): string;
export function selfLoopPath(node: any, side?: string): {
    d: string;
    points: {
        x: any;
        y: any;
...
export function autoLayout(nodes: any, edges: any, opts?: {}): void;
