...
function graphToDSL(graph, options) {
  ...
  if (Array.isArray(graph.nodes) && graph.nodes.length) {
    lines.push('nodes:');
    const fullKeys = ['id', 'kind', 'label', 'sub', 'shape', 'x', 'y', 'w', 'h', 'src', 'image', 'imageFit', 'imagePosition', 'icon', 'd'];
    const compactKeys = ['id', 'kind', 'label', 'sub', 'shape', 'src', 'image', 'imageFit', 'imagePosition', 'icon', 'd'];
...
export { BUILTIN_STYLES, BlueprintStyle, CityStyle, Diagram, EXAMPLE_GRAPH, IsoStyle, NODE_KINDS, NodeIcon, RLFlow, RLFlowElement, SHAPES, STYLES, SVG_STYLES, SketchStyle, SleekStyle, downloadPNG, downloadSVG, edgeMidpoint, getIcon, getStyle, getType, graphToDSL, hasType, listIcons, listStyles, listTypes, mount, parseDSL, pathFromPoints, registerElement, registerStyle, registerType, renderSVG, resolveGraph, roughPath, routeEdge, shapeAnchor, shapePath, sniffType, svgToString };
